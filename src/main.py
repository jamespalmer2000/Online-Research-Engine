...
if __name__ == "__main__":
    ...
    relevant_docs_list = retriever.retrieve_embeddings(web_contents, services_response['links'], query)
    content_processor = GPTAnswer(llm=llm)
    formatted_relevant_docs = content_processor._format_reference(relevant_docs_list, services_response['links'])
    ...
    ai_message_obj = content_processor.get_answer(query, formatted_relevant_docs, services_response['language'], output_format, profile)
